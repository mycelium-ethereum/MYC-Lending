...
// File contracts/src/interfaces/IMycBuyer.sol
...
// File contracts/src/interfaces/IRewardTracker.sol
...
// File solmate/src/utils/FixedPointMathLib.sol@v6.6.1
...
// File @openzeppelin/contracts-upgradeable/interfaces/draft-IERC1822Upgradeable.sol@v4.7.3
...
// File @openzeppelin/contracts-upgradeable/utils/StorageSlotUpgradeable.sol@v4.7.3
...
// File @openzeppelin/contracts-upgradeable/proxy/beacon/IBeaconUpgradeable.sol@v4.7.3
...
// File @openzeppelin/contracts-upgradeable/proxy/ERC1967/ERC1967UpgradeUpgradeable.sol@v4.7.3
...
// File @openzeppelin/contracts-upgradeable/proxy/utils/UUPSUpgradeable.sol@v4.7.3
...
// File contracts/src/V2/LentMycWithMigration.sol
 ...
 */
contract LentMycWithMigration is ERC20Upgradeable, UUPSUpgradeable {
    ...
    bool public inPausedTransferMode;
    ...
    function updateUser(address user) public onlyUnpaused {
        ...
        if (assetTransfer > 0) {
            ...
            asset.transfer(user, assetTransfer);
        }
    ...
    function claim(bool asMyc, bytes memory data) external onlyUnpaused {
        ...
        if (asMyc) {
            ...
            AddressUpgradeable.sendValue(payable(msg.sender), rewards);
        }
    ...
    function redeem(
        ...
        address receiver,
        address owner
    ) external virtual onlyUnpaused onlyUnpausedDepositWithdraw {
